          ...
          <div className="row mt-4">
              <div className="d-flex flex-row justify-content-between">
                      <div className="col-sm-2 d-flex danger flex-column">
                          ...
                          <div className="text-center text-light"> {store.planetInfo.climate} </div>
                      </div>
                      <div className="col-sm-2 d-flex flex-column">
                          <div className="text-center text-danger">Population:</div>
                          <div className="text-center text-light">{store.planetInfo.population} hab.</div>
                      </div>
                      <div className="col-sm-2 d-flex flex-column">
                          <div className="text-center text-danger">Terrain:</div>
                          <div className="text-center text-light">{store.planetInfo.terrain}</div>
                      </div>
                      <div className="col-sm-2 d-flex flex-column">
                          <div className="text-center text-danger">Orbital Period</div>
                          <div className="text-center text-light">{store.planetInfo.orbital_period} days</div>
                      </div>
                      <div className="col-sm-2 d-flex flex-column">
                          <div className="text-center text-danger">Rotation Period:</div>
                          <div className="text-center text-light">{store.planetInfo.rotation_period} hours</div>
                      </div>
               </div>
          </div>
      </div>
